...
public class MainActivity extends Activity {
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            try {
                return getMessageIdListFromApi();
            } catch (Exception e) {
                mLastError = e;
                cancel(true);
                return null;
        ...
        private List<String> getMessageIdListFromApi() throws IOException {
            String user = "me";
            ...
            //return messageIds;
            List<String> messageSnippets = new ArrayList<String>();
            for (int i = 0; i < messageIds.size(); i++) {
                Message singleMessage = mService.users().messages().get(user, messageIds.get(i)).execute();
